...
function popup(eventType, message) {
    if (eventType == 'info')    showMessageBox($('.message-box-info'), message);
    if (eventType == 'warning') showMessageBox($('.message-box-warning'), message);
    if (eventType == 'danger')  showMessageBox($('.message-box-danger'), message);
    if (eventType == 'success') showMessageBox($('.message-box-success'), message);
}

function showMessageBox(messageBoxSelector, message) {
    var box = $(messageBoxSelector);
    if(box.length > 0){
        box.find('.mb-content').html(message);
        box.toggleClass("open");
